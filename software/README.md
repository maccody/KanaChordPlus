...
KanaChord Plus' incremental IME uses the Kana characters entered by the user as a key to search dictionaries of Kanji and Japanese words.   The results of the searches are displayed in the Kanji list window.  The user can then select which Kanji character or Japanese word will replace the Kana to convey the intended meaning and send that Unicode to the host computer.  The flowcharts for
