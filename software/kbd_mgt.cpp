...
uint32_t getKanaUnicode(bool kana, bool special, uint8_t shift, uint8_t row, uint8_t col);

#define NEOPIXEL 1
/**
 * Function: kbd_setup - Initialze keyboard functionality, e.g., keyboard
 *   driver, keypad debounce, Neopixel driver.
 * Input: None.
 * Output: None:
 */
void kbd_setup (void) {
