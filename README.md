...
This chording keyboard concept is sufficient for generating all of the Kana, plus special characters.  It is impractical for Kanji, thougj, as it would quickly become impractical even with only a few dozen Kanji.  Instead, KanaChord Plus incorporates an 'incremental' IME that presents on a touch screen a list of specific Kanji characters and Japanese words according to the Hiragana or Katakana typed.  
## Features 【特徴】
